	...
	<div class="container mx-auto px-6">
		...
		<div class="hidden md:block">
			<div class="flex items-center justify-between transition-all duration-300 {isCompact ? 'py-0' : 'py-1'}">
				...
				<!-- Center: CIC -->
				<div class="mr-20 ml-[-10px] transition-all duration-300 {isCompact ? '-translate-y-0.5 transform' : ''}">
					<img
						src={logos[1].src}
						alt={logos[1].alt}
						class="{logos[1].class} w-auto mx-auto transition-transform hover:scale-105"
					/>
				</div>
