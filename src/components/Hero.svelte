...
<nav class="flex items-center bg-white justify-between px-13 py-6 pl-50 pt-12">
	<!-- Menu Items centered with equal spacing -->
	<ul class="flex space-x-6 text-sm font-medium justify-evenly flex-1 mt-5 ">
	...
	<div class="flex items-center">
		<input
			type="text"
			placeholder="Search..."
			class="border border-gray-300 rounded-md px-3 py-2 text-sm mt-2	"
		/>
	</div>
</nav>
...
<div class="top-banner bg-white h-[390px] relative">
	<!-- Image -->
	<a href="https://ibb.co/CKqGHgx9">
		<img 
		  ...
		  alt="thiru" 
		  border="0"
		  class="absolute top-1 left-5 h-full object-contain"
		/>
	  </a>
	...
	<div class="absolute right-8 top-55 transform -translate-y-1/2 flex flex-col items-start space-y-8">
		...
		<div class="flex items-center space-x-4">
		  <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 text-white flex items-center justify-center rounded-full shadow-md hover:shadow-xl transition-shadow duration-500" style="animation: softGlow 3s ease-in-out infinite;">
			1
		  </div>
		...
		<div class="flex items-center space-x-4">
		  <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-green-700 text-white flex items-center justify-center rounded-full shadow-md hover:shadow-xl transition-shadow duration-500" style="animation: softGlow 3s ease-in-out infinite;">
			2
		  </div>
		...
		<div class="flex items-center space-x-4">
		  <div class="w-12 h-12 bg-gradient-to-br from-red-500 to-red-700 text-white flex items-center justify-center rounded-full shadow-md hover:shadow-xl transition-shadow duration-500" style="animation: softGlow 3s ease-in-out infinite;">
			3
		  </div>
